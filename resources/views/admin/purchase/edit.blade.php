    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function updateGrandTotal() {
                    ...
                    // প্রতিটি row এর subtotal আবার নতুন করে হিসাব করি (পুরানো ভ্যালুতে ভরসা না করে)
                    document.querySelectorAll("#productBody tr").forEach(row => {
                        ...
                        // visible ও hidden দুটোই update করে দিই
                        row.querySelector(".subtotal").textContent = subtotal.toFixed(2);
                        let hidden = row.querySelector("input[name$='[subtotal]']");
                    ...
                    let grand = total - discount + shipping;
                    if (grand < 0) grand = 0;

                    document.getElementById("grandTotal").textContent = "TK " + grand.toFixed(2);
