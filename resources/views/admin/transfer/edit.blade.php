    ...
    <div class="content d-flex flex-column flex-column-fluid">
        <div class="d-flex flex-column-fluid">
            <div class="container-fluid my-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('update.transfer', $editData->id) }}" method="post"
                                    ...
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <input type="hidden" name="from_warehouse_id"
                                                value="{{ $editData->from_warehouse_id }}">

                                            <input type="hidden" name="to_warehouse_id"
                                                value="{{ $editData->to_warehouse_id }}">
                                                    ...
                                                    <select name="from_warehouse_id" id="warehouse_id"
                                                        ...
                                                        @foreach ($warehouses as $item)
                                                            <option value="{{ $item->id }}"
                                                                {{ $editData->from_warehouse_id == $item->id ? 'selected' : '' }}>
                                                                {{ $item->name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group w-100">
                                                    ...
                                                    <select name="to_warehouse_id" id="warehouse_id"
                                                        ...
                                                        @foreach ($warehouses as $item)
                                                            <option value="{{ $item->id }}"
                                                                {{ $editData->to_warehouse_id == $item->id ? 'selected' : '' }}>
                                                                {{ $item->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <small id="warehouse_error" class="text-danger d-none">Please select the
                                                ...
                                                <div class="form-group w-100">
                                                    ...
                                                    <select name="status" id="status"
                                                        ...
                                                        <option value="Transfer"
                                                            {{ $editData->status == 'Transfer' ? 'selected' : '' }}>
                                                            Transfer</option>
