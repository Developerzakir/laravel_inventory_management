...
class SaleReturnController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.return-sale.index', compact('allData'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.return-sale.create', compact('customers', 'warehouses'));
    }
    ...
    public function edit($id)
    {
        ...
        $customers = Customer::all();
        $warehouses = WareHouse::all();
        return view('admin.return-sale.edit', compact('editData', 'customers', 'warehouses'));
    }
    ...
    public function detailsSalesReturn($id)
    {
        ...
        return view('admin.return-sale.sales_return_details', compact('sales'));
    }
    ...
    public function dueSale()
    {
        ...
        $sales = Sale::with(['customer', 'warehouse'])
            ...
            ->where('due_amount', '>', 0)
            ->get();
        return view('admin.due.sale_due', compact('sales'));
    }
    ...
    public function dueSaleReturn()
    {
        $sales = SaleReturn::with(['customer', 'warehouse'])
            ...
            ->where('due_amount', '>', 0)
            ->get();
        return view('admin.due.sale_return_due', compact('sales'));
    }
}
