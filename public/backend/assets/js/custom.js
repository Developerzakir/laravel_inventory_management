  ...
  function updateDueAmount() {
        let grandTotal =
            parseFloat(document.querySelector("input[name='grand_total']").value) ||
            0;
        let paidAmount =
            parseFloat(document.querySelector("input[name='paid_amount']").value) ||
            0;
        // new add full paid functionality
        let fullPaidAmount =
            parseFloat(document.querySelector("input[name='full_paid']").value) ||
            0;
        ...
        document.getElementById("dueAmount").textContent = `TK ${dueAmount.toFixed(
            2
        )}`;
