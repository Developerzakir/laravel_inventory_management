                            ...
                            <table id="datatable" class="table table-bordered dt-responsive table-responsive nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->status }}</td>
                                        <td>
                                             @foreach($item->purchaseItems as $p)
                                                ${{ $p->subtotal }} <br>
                                             @endforeach
                                        </td> 
                                        <td>Cash</td>
                                        ...
                                        <td>
                                            ...
                                            <a title="PDF Invoice" href="{{ route('details.purchase',$item->id) }}" class="btn btn-primary btn-sm"> <span class="mdi mdi-download-circle mdi-18px"></span> </a> 
